...
The backend is built using __ElysiaJS__, providing a high-performance and minimal API layer. The system integrates Ollama to run the __Qwen3 0.6B__ language model locally, enabling private and efficient inference without relying on external AI APIs.
